...
RSpec.describe UserMailer, type: :mailer do
  include Rails.application.routes.url_helpers    #We use this here as we will use rails helpers (achievement_url)
  ...
  it 'has correct subject' do
    expect(email.subject).to eq('Congratulations with the new achievement')
  end
